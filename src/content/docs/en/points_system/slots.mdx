...
You will import 1 ***Command***, `!slot, !slots` this is how your viewers will play the game. No other commands are needed for this to work. 

You have 6 new ***Triggers*** that have been created they are as follows

```
Currency >> Slots >> Win
Currency >> Slots >> Loss
Currency >> Slots >> All In Win
Currency >> Slots >> All In Loss
Currency >> Slots >> Any Win
Currency >> Slots >> Any Loss
```
If you don't want to specify a different ***Action*** based on the user going all in or not then use the `Any Win/Loss` ***Triggers***. If you want a different ***Action*** based on going all in the use the `Win/Loss` and `All In Win/Loss` ***Triggers***.

Each Trigger will populate the following Arguments.
|Argument | Description|
|---|---|
|`rolledEmote1`|This is the value of the 1st emote.|
|`rolledEmote2`|This is the value of the 2nd emote.|
|`rolledEmote3`|This is the value of the 3rd emote.|
