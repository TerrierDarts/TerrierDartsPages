...
**So if you haven't I would really appreciate the support, and these are two ways you can do it for FREE. (The same price as my extensions I've built)**

I want to do a darts related charity stream where I throw darts for I Try do the 100K challenge I think this will take me around 10/12 hours to do. Im planning on some ways to make it harder with donations (Throw for Bull, Doubles, Step Forward, Step Back, Change Darts)

Relay Charity Stream, where we several streamers do 2 hour slots and we go for hopefully 48 hours.

I would also like to work with a brand and produce some videos based on that.
